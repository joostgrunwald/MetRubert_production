...
class VUAProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir, dev_dir):
        """See base class."""
...
wrongdevs = open("output/wrong_devs.txt", "w")
        ...
        if args.use_local_context:
            ...
            if isinstance(tokens_b, list):
                ...
                if len(tokens_b) == 1:
                    ...
                    wrongdevs.write(
                        str(ex_index) + " , " + example.text_a + " , " + example.text_b + "\n"
                    )
